    ...
    const handleSubmit = async (values, { setSubmitting, setStatus, resetForm }) => {
        try {
            ...
            if (response.ok) {
                ...
                if (errorResult.risk_score) {
                    if (errorResult.risk_score > 70) {
                        setStatus({
                            error: 'Registration rejected due to high risk factors. Please contact support.',
                        });
                    } else {
                        setStatus({
                            error: 'Registration requires manual review. We will contact you shortly.',
                        });
                    }
                } else {
